...
urlpatterns = [
    ...
    path('form/edit/<int:pk>/', views.edit_game, name='edit_game'),
    path('form/delete/<int:pk>/', views.delete_game, name='delete_game'),
    path("add", views.fetch_and_save, name="add_game"),
    path('userlist/<int:pk>/', views.user_game_list, name='user_game_list'),
    path('mylist/', views.user_game_list, name='my_game_list'),
